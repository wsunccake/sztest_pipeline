...
ID_FILE=application_policy_v2_ids.log
INPUT_NUMBER=1000
TMP_DIR=`mktemp -d`
...
'''
        ...
        stage('Check Response') {
            steps {
                script {
                    def result = util.checkResponseStatus "${VAR_DIR}/output/delete_application_policy", "204"
                    println result
        ...
        stage('Statistic Response') {
            steps {
                script {
                    util.statisticizeResponse "${VAR_DIR}/output/delete_application_policy", "204"
                }
            }
        }
