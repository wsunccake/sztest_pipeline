...
split -l $INPUT_NUMBER $VAR_DIR/output/id/device_policy_ids.log $TMP_DIR/in_
...
'''
        ...
        stage('Check Response') {
            steps {
                script {
                    def result = util.checkResponseStatus "${VAR_DIR}/output/delete_device_policy"
                    println result
        ...
        stage('Statistic Response') {
            steps {
                script {
                    util.statisticizeResponse "${VAR_DIR}/output/delete_device_policy"
                }
            }
        }
