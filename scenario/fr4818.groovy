...
node {
    properties([
            parameters([
                    // common
                    string(name: 'SZ_VERSION', defaultValue: '5.2.1.0.515'),
                    string(name: 'SCENARIO', defaultValue: 'rf4818'),
...
//                    string(name: 'DATA_DIR', defaultValue: '/usr/share/nginx/html/api_perf/rf4818/report/${SCENARIO}', description: ''),
